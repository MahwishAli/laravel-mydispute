            ...
            <div class="col-lg-11 col-md-12 ini-signup-form form-all bg-white mb-5">
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <!-- Specific Industry (Visible only if Commercial is selected) -->
                        ...
                        <!-- Services Provided -->
                        <div class="col-md-6 mb-2">
                            <label class="form-label">Please select what services you provide: <span class="text-danger">*</span></label>
                            <div class="form-check">
                            ...
                            <div id="specializedServicesDis" class="mt-3" style="display: none;">
