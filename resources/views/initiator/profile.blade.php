                                    ...
                                    <div class="row">
                                        <form method="post" id="privacyDetails">
                                            ...
                                            <div class="col-lg-12 col-md-12 mt-4">
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="unsubscribe" value="Unsubscribe">
                                            ...
                                            <div class="col-lg-12 col-md-12 mt-4">
                                                ...
                                                <div class="form-check mb-2">
                                                    ...
                                                    <label class="form-check-label" for="busy_status">Available for Consultancy Work
                                                    </label>
                                                </div>
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="radio" name="busy_status" value="Not Available for Consultancy Work">
                                                    <label class="form-check-label" for="busy_status">Not Available for Consultancy Work
                                                    </label>
                                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('input[name="busy_status"]').on('change', function() {
